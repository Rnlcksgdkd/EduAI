...
def MultipleChoiceQuestion_logic_check(model , question):
    ...
    for choice in choices:
        ...
        print(f"사실 여부 : {is_error} ({is_error_prob})")
...
def logicGraph():
    ...
    with open("LogicGraph.png", "wb") as f:
        f.write(img.data)
...
if __name__ == "__main__":
    ...
    # 모델 선택
    model_manager = ModelManager(['o3-mini'])

    # 논리적 오류 검증할 문제 파일 선택
    input_file_path = '../generate/ADsP_통계_20250405_1122.json'
